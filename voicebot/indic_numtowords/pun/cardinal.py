from voicebot.indic_numtowords.pun.data.nums import exceptions_dict
from voicebot.indic_numtowords.pun.data.nums import direct_dict
from voicebot.indic_numtowords.pun.data.nums import higher_dict

from voicebot.indic_numtowords.pun.utils import combine
