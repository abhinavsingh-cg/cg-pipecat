from voicebot.indic_numtowords.nep.data.nums import DIRECT_DICT
from voicebot.indic_numtowords.nep.data.nums import NUMBER_SCALE_DICT
from voicebot.indic_numtowords.nep.data.nums import VARIATIONS_DICT
from voicebot.indic_numtowords.nep.utils import combine
