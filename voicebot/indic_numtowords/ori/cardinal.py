from voicebot.indic_numtowords.ori.data.nums import exceptions_dict
from voicebot.indic_numtowords.ori.data.nums import direct_dict
from voicebot.indic_numtowords.ori.data.nums import higher_dict

from voicebot.indic_numtowords.ori.utils import combine
