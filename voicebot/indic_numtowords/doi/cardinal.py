from voicebot.indic_numtowords.doi.data.nums import DIRECT_DICT
from voicebot.indic_numtowords.doi.data.nums import NUMBER_SCALE_DICT
from voicebot.indic_numtowords.doi.data.nums import VARIATIONS_DICT
from voicebot.indic_numtowords.doi.utils import combine
