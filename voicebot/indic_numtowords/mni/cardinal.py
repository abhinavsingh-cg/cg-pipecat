from voicebot.indic_numtowords.mni.data.nums import DIRECT_DICT
from voicebot.indic_numtowords.mni.data.nums import HUNDREDS_DICT
from voicebot.indic_numtowords.mni.data.nums import NUMBER_SCALE_DICT
from voicebot.indic_numtowords.mni.data.nums import VARIATIONS_DICT
from voicebot.indic_numtowords.mni.utils import combine
